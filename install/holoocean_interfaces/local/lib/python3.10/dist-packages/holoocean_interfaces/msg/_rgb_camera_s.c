...
bool holoocean_interfaces__msg__rgb_camera__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("holoocean_interfaces.msg._rgb_camera.RGBCamera", full_classname_dest, 46) == 0);
  }
  holoocean_interfaces__msg__RGBCamera * ros_message = _ros_message;
  {  // timestamp
  ...
  {  // image
    ...
    if (PyObject_CheckBuffer(field)) {
      ...
      int16_t * dest = ros_message->image.data;
...
{
  /* NOTE(esteve): Call constructor of RGBCamera */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("holoocean_interfaces.msg._rgb_camera");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RGBCamera");
  ...
  {  // image
    ...
    if (ros_message->image.size > 0) {
      ...
      int16_t * src = &(ros_message->image.data[0]);
      PyObject * data = PyBytes_FromStringAndSize((const char *)src, ros_message->image.size * sizeof(int16_t));
      assert(data != NULL);
