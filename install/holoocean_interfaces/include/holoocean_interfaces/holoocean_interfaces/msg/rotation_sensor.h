...
#ifndef HOLOOCEAN_INTERFACES__MSG__ROTATION_SENSOR_H_
#define HOLOOCEAN_INTERFACES__MSG__ROTATION_SENSOR_H_
...
#endif  // HOLOOCEAN_INTERFACES__MSG__ROTATION_SENSOR_H_
