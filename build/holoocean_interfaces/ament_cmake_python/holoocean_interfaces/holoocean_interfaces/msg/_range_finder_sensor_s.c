...
bool holoocean_interfaces__msg__range_finder_sensor__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("holoocean_interfaces.msg._range_finder_sensor.RangeFinderSensor", full_classname_dest, 63) == 0);
  }
  holoocean_interfaces__msg__RangeFinderSensor * ros_message = _ros_message;
  {  // timestamp
...
{
  /* NOTE(esteve): Call constructor of RangeFinderSensor */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("holoocean_interfaces.msg._range_finder_sensor");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "RangeFinderSensor");
