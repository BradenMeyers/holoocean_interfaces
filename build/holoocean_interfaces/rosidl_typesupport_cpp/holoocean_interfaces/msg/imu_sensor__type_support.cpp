...
static const _IMUSensor_type_support_symbol_names_t _IMUSensor_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, holoocean_interfaces, msg, IMUSensor)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, holoocean_interfaces, msg, IMUSensor)),
  }
};
...
{
  return &::holoocean_interfaces::msg::rosidl_typesupport_cpp::IMUSensor_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, holoocean_interfaces, msg, IMUSensor)() {
  return get_message_type_support_handle<holoocean_interfaces::msg::IMUSensor>();
}
