...
static const _RGBCamera_type_support_symbol_names_t _RGBCamera_message_typesupport_symbol_names = {
  {
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, holoocean_interfaces, msg, RGBCamera)),
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_cpp, holoocean_interfaces, msg, RGBCamera)),
  }
};
...
{
  return &::holoocean_interfaces::msg::rosidl_typesupport_cpp::RGBCamera_message_type_support_handle;
}
...
ROSIDL_TYPESUPPORT_CPP_PUBLIC
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_cpp, holoocean_interfaces, msg, RGBCamera)() {
  return get_message_type_support_handle<holoocean_interfaces::msg::RGBCamera>();
}
