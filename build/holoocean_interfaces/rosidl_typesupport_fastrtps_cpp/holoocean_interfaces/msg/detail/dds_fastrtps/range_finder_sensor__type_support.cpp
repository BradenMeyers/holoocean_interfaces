...
#include "holoocean_interfaces/msg/detail/range_finder_sensor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const holoocean_interfaces::msg::RangeFinderSensor & ros_message,
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  holoocean_interfaces::msg::RangeFinderSensor & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
...
size_t
ROSIDL_TYPESUPPORT_FASTRTPS_CPP_PUBLIC_holoocean_interfaces
max_serialized_size_RangeFinderSensor(
  bool & full_bounded,
  bool & is_plain,
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = holoocean_interfaces::msg::RangeFinderSensor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const holoocean_interfaces::msg::RangeFinderSensor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<holoocean_interfaces::msg::RangeFinderSensor *>(
    untyped_ros_message);
  return cdr_deserialize(cdr, *typed_message);
}

static uint32_t _RangeFinderSensor__get_serialized_size(
  const void * untyped_ros_message)
{
  auto typed_message =
    static_cast<const holoocean_interfaces::msg::RangeFinderSensor *>(
...
static size_t _RangeFinderSensor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_RangeFinderSensor(full_bounded, is_plain, 0);
...
static message_type_support_callbacks_t _RangeFinderSensor__callbacks = {
...
static rosidl_message_type_support_t _RangeFinderSensor__handle = {
  rosidl_typesupport_fastrtps_cpp::typesupport_identifier,
  &_RangeFinderSensor__callbacks,
...
{
  return &holoocean_interfaces::msg::typesupport_fastrtps_cpp::_RangeFinderSensor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, holoocean_interfaces, msg, RangeFinderSensor)() {
  return &holoocean_interfaces::msg::typesupport_fastrtps_cpp::_RangeFinderSensor__handle;
}
