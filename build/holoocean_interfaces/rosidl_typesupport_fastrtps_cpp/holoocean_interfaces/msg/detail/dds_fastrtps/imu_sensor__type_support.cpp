...
#include "holoocean_interfaces/msg/detail/imu_sensor__rosidl_typesupport_fastrtps_cpp.hpp"
...
cdr_serialize(
  const holoocean_interfaces::msg::IMUSensor & ros_message,
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  {
    cdr << ros_message.acceleration_bias;
  }
  // Member: angular_velocity_bias
  {
    cdr << ros_message.angular_velocity_bias;
  }
  return true;
}
...
cdr_deserialize(
  eprosima::fastcdr::Cdr & cdr,
  holoocean_interfaces::msg::IMUSensor & ros_message)
{
  // Member: timestamp
  cdr >> ros_message.timestamp;
  ...
  size_t current_alignment)
{
  ...
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.acceleration_bias[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  // Member: angular_velocity_bias
  {
    size_t array_size = 3;
    size_t item_size = sizeof(ros_message.angular_velocity_bias[0]);
    current_alignment += array_size * item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = holoocean_interfaces::msg::IMUSensor;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const holoocean_interfaces::msg::IMUSensor *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<holoocean_interfaces::msg::IMUSensor *>(
    untyped_ros_message);
...
static size_t _IMUSensor__max_serialized_size(char & bounds_info)
{
  ...
  ret_val = max_serialized_size_IMUSensor(full_bounded, is_plain, 0);
...
{
  return &holoocean_interfaces::msg::typesupport_fastrtps_cpp::_IMUSensor__handle;
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_fastrtps_cpp, holoocean_interfaces, msg, IMUSensor)() {
  return &holoocean_interfaces::msg::typesupport_fastrtps_cpp::_IMUSensor__handle;
}
